...
# ovs1 <- gUtils::gr.findoverlaps(gr_data[[1]], dr_mfli, scol = c("RepeatID", "id"), qcol="Freq_5mCpG", return.type = "data.table")
# # }
...
# ovs1_stats <- ovs1_stats[unique(ovs1[, c("id", "RepeatID")]), on = c("RepeatID"), nomatch = NULL]
...
# ovs1_stats[,summarise(`Freq_5mCpG.N`)]
# write_tsv(resultsOverlapsStats_dt, file = "dt_ovlps_stats.tsv")
...
pdf(paste0("full_length_L1RNA_DNAme_DMSO",".pdf"), width=9, height=9)
